 ...
 */
package com.dumbdogdiner.worldguardextraflags.flags;

import com.dumbdogdiner.worldguardextraflags.flags.data.SoundData;
import com.dumbdogdiner.worldguardextraflags.flags.helpers.BlockMaterialFlag;
import com.dumbdogdiner.worldguardextraflags.flags.helpers.ForcedStateFlag;
import com.dumbdogdiner.worldguardextraflags.flags.helpers.PotionEffectFlag;
import com.dumbdogdiner.worldguardextraflags.flags.helpers.PotionEffectTypeFlag;
import com.dumbdogdiner.worldguardextraflags.flags.helpers.SoundDataFlag;
...
public final class Flags {
    ...
    public final static SetFlag<String> COMMAND_ON_ENTRY =
            WorldGuardUtils.getCommunicator().getCustomSetFlag("command-on-entry", new CommandStringFlag(null));
    public final static SetFlag<String> COMMAND_ON_EXIT =
            WorldGuardUtils.getCommunicator().getCustomSetFlag("command-on-exit", new CommandStringFlag(null));

    public final static SetFlag<String> CONSOLE_COMMAND_ON_ENTRY =
            WorldGuardUtils.getCommunicator().getCustomSetFlag("console-command-on-entry", new CommandStringFlag(null));
    public final static SetFlag<String> CONSOLE_COMMAND_ON_EXIT =
            WorldGuardUtils.getCommunicator().getCustomSetFlag("console-command-on-exit", new CommandStringFlag(null));
    ...
    public final static SetFlag<PotionEffectType> BLOCKED_EFFECTS =
            new SetFlag<PotionEffectType>("blocked-effects", new PotionEffectTypeFlag(null));
    ...
    public final static SetFlag<PotionEffect> GIVE_EFFECTS =
            new SetFlag<PotionEffect>("give-effects", new PotionEffectFlag(null));
    ...
    public final static SetFlag<Material> ALLOW_BLOCK_PLACE =
            new SetFlag<Material>("allow-block-place", new BlockMaterialFlag(null));
    public final static SetFlag<Material> DENY_BLOCK_PLACE =
            new SetFlag<Material>("deny-block-place", new BlockMaterialFlag(null));
    public final static SetFlag<Material> ALLOW_BLOCK_BREAK =
            new SetFlag<Material>("allow-block-break", new BlockMaterialFlag(null));
    public final static SetFlag<Material> DENY_BLOCK_BREAK =
            new SetFlag<Material>("deny-block-break", new BlockMaterialFlag(null));

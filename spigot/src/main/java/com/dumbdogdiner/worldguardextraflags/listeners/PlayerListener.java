...
public class PlayerListener implements Listener {
    ...
    public void onPlayerDeathEvent(PlayerDeathEvent event) {
        ...
        Boolean keepInventory =
                WorldGuardUtils.queryValue(player, player.getWorld(), regions.getRegions(), Flags.KEEP_INVENTORY);
    ...
    public void onPlayerRespawnEvent(PlayerRespawnEvent event) {
        ...
        Object respawnLocation = WorldGuardUtils.queryValueUnchecked(player, player.getWorld(), regions.getRegions(),
    ...
    public void onPlayerItemConsumeEvent(PlayerItemConsumeEvent event) {
        ...
        if (itemMeta instanceof PotionMeta) {
            this.plugin.getWorldGuardCommunicator().getSessionManager().get(player)
                    .getHandler(GiveEffectsFlagHandler.class)
                    .drinkPotion(player, Potion.fromItemStack(event.getItem()).getEffects());
        } else {
    ...
    private void checkFlyStatus(Player player) {
        Boolean value = this.plugin.getWorldGuardCommunicator().getSessionManager().get(player)
    ...
    public void onPlayerItemDamageEvent(PlayerItemDamageEvent event) {
        ...
        ApplicableRegionSet regions = this.plugin.getWorldGuardCommunicator().getRegionContainer().createQuery()
                .getApplicableRegions(player.getLocation());
        if (WorldGuardUtils.queryState(player, player.getWorld(), regions.getRegions(),
    ...
    public void onPlayerSpawnLocationEvent(PlayerSpawnLocationEvent event) {
        ...
        Object location = WorldGuardUtils.queryValueUnchecked(player, player.getWorld(), regions.getRegions(),
                Flags.JOIN_LOCATION);
        if (location != null) {
